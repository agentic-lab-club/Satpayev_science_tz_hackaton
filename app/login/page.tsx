      ...
      <header className="relative z-10 border-b border-slate-700/50 bg-slate-900/30 backdrop-blur-md sticky top-0">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-xs text-slate-400">
            Нет аккаунта?{" "}
            <Link href="/registration" className="text-amber-400 hover:text-amber-300 transition-colors font-semibold">
              Зарегистрируйтесь
            </Link>
          </div>
        </div>
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3">Добро пожаловать</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-xs">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" defaultChecked className="w-4 h-4 accent-amber-400 rounded" />
                  <span className="text-slate-400">Помнить меня</span>
                </label>
